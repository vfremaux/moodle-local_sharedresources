...
$string['notaxonomiesenabled'] = 'No taxonomy was setup in the library. You cannot use the taxonomy "browser".';
...
$string['previous'] = 'Previous version';
...
$string['simplemode'] = 'Simple search';
$string['fullmode'] = 'Fulls search';
