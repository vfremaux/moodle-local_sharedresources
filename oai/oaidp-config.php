...
*/
//
// $Id: oaidp-config.php,v 1.1 2011-09-28 20:55:08 vf Exp $
//
...
$baseURL			  = $CFG->wwwroot.'/resources/oai/oai2.php';
...
$catalogName = 'Pairformance';

// set the resource access URL scheme
// $resourceBaseURL = $CFG->wwwroot.'/mod/sharedresource/view.php?';

// typical Pairformance implementation scheme. Resource are acessible through a dedicated 
// fake subdomain
